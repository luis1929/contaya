const features = [
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#BE3B5E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const styles = {
  section: { padding: '6rem 2rem', background: '#fff', color: '#062A51' },
  ...
  subtitle: { color: '#4a5a72', fontSize: '1.05rem', maxWidth: '600px', margin: '0 auto', lineHeight: '1.7' },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.5rem' },
  card: {
    background: '#f8f9fc', border: '1px solid #e8ecf0', borderRadius: '16px', padding: '2rem',
  ...
  cardTitle: { fontSize: '1.15rem', fontWeight: '700', marginBottom: '0.75rem', color: '#062A51' },
  cardDesc: { color: '#4a5a72', lineHeight: '1.7', fontSize: '0.9rem' },
};
